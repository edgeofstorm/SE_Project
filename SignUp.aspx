    ...
    <div class="container">
        ...
        <div class="form-group">
            ...
            <div class="col-md-8">
                ...
                <asp:regularexpressionvalidator runat="server" controltovalidate="kullanici_adi" display="Dynamic" validationexpression="^[a-zA-Z0-9\s]{1,100}$" errormessage="*Sadece harfler ve sayılar" forecolor="Red" validationgroup="RequestVali"></asp:regularexpressionvalidator>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-8">
                ...
                <asp:regularexpressionvalidator runat="server" controltovalidate="parola" display="Dynamic" validationexpression="^[a-zA-Z0-9şŞçÇğĞİöÖüÜı\s]{1,16}$" errormessage="*Sadece harfler ve sayılar" forecolor="Red" validationgroup="RequestVali"></asp:regularexpressionvalidator>
             </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-8">
                ...
                <asp:regularexpressionvalidator runat="server" controltovalidate="parola_tekrar" display="Dynamic" validationexpression="^[a-zA-Z0-9şŞçÇğĞİöÖüÜı\s]{1,16}$" errormessage="*Sadece harfler ve sayılar" forecolor="Red" validationgroup="RequestVali"></asp:regularexpressionvalidator>
        ...
        <div class="form-group">
            ...
            <div class="col-md-8">
                <asp:textbox id="adres" runat="server" cssclass="form-control input-md" textmode="MultiLine"></asp:textbox>
